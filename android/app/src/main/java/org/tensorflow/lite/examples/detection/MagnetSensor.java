...
public class MagnetSensor {
    ...
    private static class TriggerDetector implements Runnable,
        ...
        private org.tensorflow.lite.examples.detection.MagnetSensor.OnCardboardTriggerListener mListener;
        ...
        public synchronized void setOnCardboardTriggerListener(
                org.tensorflow.lite.examples.detection.MagnetSensor.OnCardboardTriggerListener listener,
                Handler handler) {
            ...
            synchronized (this) {
                if (this.mListener != null) {
                    this.mHandler.post(new Runnable() {
                        public void run() {
                            org.tensorflow.lite.examples.detection.MagnetSensor.TriggerDetector.this.mListener
                                    .onCardboardTrigger();
                        }
                    });
                }
